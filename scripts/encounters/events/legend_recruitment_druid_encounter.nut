this.legend_recruitment_druid_encounter <- this.inherit("scripts/encounters/encounter", {
    ...
    function createScreens() {
        this.m.Screens.push({
			...
			Text = "[img]gfx/ui/events/event_25.png[/img]{From a distance, you see a great blaze, nearly the size of a small mountain, over a section of the old woods. You reckon it\'s perhaps a little under an hour\'s trek, but you feel oddly compelled to pay tribute to the death of something that has spanned so many centuries.}",
            Image = "",
            List = [],
			Characters = [],
			Options = [
