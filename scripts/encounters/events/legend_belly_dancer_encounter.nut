this.legend_belly_dancer_encounter <- this.inherit("scripts/encounters/encounter", {
    ...
    function createScreens() {
		...
		this.m.Screens.push({
			ID = "B",
			Text = "[img]gfx/ui/events/event_163.png[/img]{You take out a crown and flip it to the dancer. Her eyes catch its glint, but she doesn\'t break the dance. She drops her weapons and sashays over, cymbals clattering, hips gyrating, her knees hardly bending, her feet almost mystically carrying her across the ground. She claps the cymbals in your face, then swings around, briefly bumping you with her hips, and starts to dance back to the middle. She picks up your coin with a toe and flips it up and it lands in a clay pot. The crowd cheers.}";
			Image = "",
			List = [],
			Characters = [],
			Options = [
